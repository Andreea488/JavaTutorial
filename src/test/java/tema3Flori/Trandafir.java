...
public class Trandafir extends Floare {
    ...
    public Trandafir(String tip, String sezon, boolean deGradina, boolean salbatica, boolean perena, String culoare, int nrSpecii, String provenienta, List<String> intretinere) {
        super(tip, sezon, deGradina, salbatica, perena, culoare, nrSpecii, provenienta);
        this.intretinere = intretinere;
    }

    public void prezentareTrandafir() {
        prezentareFloare();
        System.out.println("Intretinerea se face prin: ");
        for (int i = 0; i < intretinere.size(); i++) {
            System.out.println(i + ". " + intretinere.get(i));
        }
        System.out.println("Inmultirea se face prin "+inmultire);
    }
}
