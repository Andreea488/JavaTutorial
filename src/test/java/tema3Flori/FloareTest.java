...
public class FloareTest {
    ...
    public void testMethod(){
        ...
        Brandusa brandusa = new Brandusa("Crocus", "Primavara si toamna", true, true, true, "multicolora", 90, "Balcani si Romania", intretinereBrandusa);
        ...
        Margareta margareta = new Margareta("Anthemis", "Primavara", true, true, true, "multicolor", 100, "Regiunea Mediterana si Asia", intretinereMargareta);
        ...
        Orhidee orhidee = new Orhidee("Phalaenopsis", "Primavara si vara", false, true, true, "multicolora", 60, "Asia", intretinereOrhidee);
        ...
        Trandafir trandafir = new Trandafir("Teahibrid","Primavara si toamna", true, false, true, "multicolora", 100, "Franta", intretinereTrandafir);
