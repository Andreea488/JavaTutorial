...
public class Orhidee extends Floare {

    public List<String> intretinere;

    public Orhidee(String tip, String sezon, boolean deGradina, boolean salbatica, boolean perena, String culoare, int nrSpecii, String provenienta, List<String> intretinere) {
        super(tip, sezon, deGradina, salbatica, perena, culoare, nrSpecii, provenienta);
        this.intretinere = intretinere;
    }

    public void prezentareOrhidee() {
        prezentareFloare();
