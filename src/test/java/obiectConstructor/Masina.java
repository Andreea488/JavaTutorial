...
public class Masina {
    ...
    //in momentul cand cream un obiect se aloca spatiu in memorie special pt aceasta reprezentare
    ...
    public void prezentareComandaMasina(){
        ...
        System.out.println("Kilometrii masinii: "+nrKm);
        if (pret > 0) {
    ...
    //daca greutatea este pana in 2000kg trebuie sa platim 5 lei
    //daca greutatea este cuprinsa intre 2000 si 4000 trebuie sa platim 10 lei
    //daca este peste 4000 platim 15 lei
